...
#define I2C_SCL_PINCM																		(OLED_OLED_SCL_IOMUX)

#define I2C_SDA_PINCM       														(OLED_OLED_SDA_IOMUX)

#define I2C_SCL_PIN    																	  (OLED_OLED_SCL_PIN)
#define I2C_SDA_PIN    																	  (OLED_OLED_SDA_PIN)
